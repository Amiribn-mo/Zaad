  ...
  return (
    <div className="container flex flex-col items-center gap-5 h-auto py-6 sm:w-11/12">
      ...
      >
        ...
        </div>{isLoaded?<svg onClick={close} className="h-8 w-8 text-gray-700 hover:text-gray-900 cursor-pointer" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
